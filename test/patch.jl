...
facts("Patch tests", using_fixtures) do
  ...
  add_fixture(checkmylist, checkmylist, :context)
  ...
  context("patch second value of mylist", using_fixtures) do
  ...
  context("patch third value of mylist", using_fixtures) do
  ...
  context("patch fourth value of mylist", using_fixtures) do
  ...
  context("patch global variable and check the return value", using_fixtures) do
